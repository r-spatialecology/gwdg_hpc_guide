...
For *Windows*, [this guide](https://docs.joyent.com/public-cloud/getting-started/ssh-keys/generating-an-ssh-key-manually/manually-generating-your-ssh-key-in-windows) seems to cover how to connect via SSH. Using *Windows 10*, it should be also possible to use the new OpenSSH client.
